...
from app.reports.service import PERIODS, ReportBuilder
...
def generate_report(body: GenerateBody, merchant=Depends(require_merchant),
...
@router.get("/pdf")
def report_pdf(period: str = Query(pattern="^(daily|weekly|monthly)$"),
    ...
    return Response(content=pdf_bytes,
                    ...
                    headers={"Content-Disposition": f"attachment; filename=aegis_report_{period}.pdf",
