...
def _orch(policies):
    return DecisionOrchestrator(
        rules=None, ml=None, graph=None, aml_service=None, features=None,
        transactions=None, decisions=None, alerts=None, cases=None, audit=None,
        events=None, notifications=None, tenants=_Tenants(policies),
    )
...
def test_hard_sanctions_block_and_invalid_threshold_order_is_ignored():
    ...
    assert policy["thresholds"]["challenge"] <= policy["thresholds"]["review"] <= policy["thresholds"]["block"]
